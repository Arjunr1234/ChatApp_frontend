...
function HomePage() {
  ...
  {messages.filter(
    ...
    <div className="flex items-center justify-center h-full">
      <p className="text-gray-500 text-2xl font-bold  bg-white px-6 py-3 rounded-lg shadow-lg border border-gray-300 transition-transform duration-300 hover:scale-105">
        Start Conversation
      </p>
    </div>
  )
